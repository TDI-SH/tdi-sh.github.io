...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_26.setTransform(181.5,107,1,1,0,0,0,116.5,23);

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(23).to({y:129},4,cjs.Ease.get(-1)).to({_off:true},1).wait(350));
