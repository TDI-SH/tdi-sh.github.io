...
p.nominalBounds = new cjs.Rectangle(0,0,164,52);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_26.setTransform(184.5,117,1,1,0,0,0,116.5,23);

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(23).to({y:139},4,cjs.Ease.get(-1)).to({_off:true},1).wait(359));
